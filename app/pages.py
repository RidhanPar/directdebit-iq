...
# Page implementations are kept separate from the thin Streamlit entrypoint.
...
from app.automation_page import page_action_automation  # noqa: E402
...
def main() -> None:
    ...
    with st.sidebar:
        ...
        show_automation = st.checkbox(
            "Automation & Audit Evidence",
            value=False,
            help="Shows the authenticated score-to-approval-to-retry operational workflow.",
        )
        st.markdown("---")
